...
public class Tugas2 {
     public static void main(String[] args) {
        String nama = "Akbar Vito Hartono / X RPL 5 / 05";
        ...
        System.out.println("Jenis barang dan jumlah tiap barang yang harus dibawa untuk mendapatkan gaji maksimal yaitu :");
